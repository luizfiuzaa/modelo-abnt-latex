...
\newcommand{\alunos}{\aluno \\ B \\ C \\ ...}
\newcommand{\professor}{Houdini}
\newcommand{\materia}{Lorem Ipsum}
\newcommand{\tema}{John Doe}
\newcommand{\nomeinstituicao}{UniSquina - Prof. Houdini}
\newcommand{\areainstituicao}{Faculdade de Tecnologia de Lorem}
% ---
% Informações de dados para CAPA e FOLHA DE ROSTO
% ---
\titulo{Lorem \\ Ispum}
\autor{\aluno}
\local{Municipio/Sigla}
\data{2025, 1º Semestre}
\instituicao{
  \nomeinstituicao
  \par
  \areainstituicao
}
\tipotrabalho{Pesquisa e Análise técnica}
% O preambulo deve conter o tipo do trabalho, o objetivo, 
% o nome da instituição e a área de concentração 
\preambulo{Pesquisa e análise sobre \tema, com finalidade de obtenção de menção e presença para as aulas de Inteligência Artificial e Aprendizagem de Máquina. \\ \\ Professor Orientador: \professor}
% ---
% ---
